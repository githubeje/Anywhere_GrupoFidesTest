...
var nombreModulo = "4. Fotos Góndola";
...
reiniciaFotos();
createPhotoButton(1,true, true, "Foto Aguas.");
createPhotoButton(2,true, true, "Foto Gaseosas.");
createPhotoButton(3,true, true, "Foto Isotónicos.");
createPhotoButton(4,true, true, "Foto Jugos Liquidos.");
